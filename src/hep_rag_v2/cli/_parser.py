...
def build_parser() -> argparse.ArgumentParser:
    ...
    s.add_argument("--parser-name", default=None, help="Restrict to documents registered by a specific parser_name, e.g. pdg_website_pdf")
    ...
    s.add_argument("--artifact", choices=["full", "website", "sqlite"], default=None, help="PDG artifact profile to import; defaults to config.pdg.default_artifact")
    s.add_argument("--source", default=None, help="Local PDG source path: website zip/dir or sqlite DB")
