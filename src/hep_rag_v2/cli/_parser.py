...
def build_parser() -> argparse.ArgumentParser:
    ...
    s.add_argument("--parser-name", default=None, help="Restrict to documents registered by a specific parser_name, e.g. pdg_book_pdf")
    ...
    s.add_argument("--artifact", choices=["full", "website", "book_pdf", "booklet_pdf", "sqlite"], default=None, help="PDG artifact profile to import; defaults to config.pdg.default_artifact")
    s.add_argument("--source", default=None, help="Local PDG source path: website zip/dir, sqlite DB, or PDF file")
    ...
    s.add_argument("--pdf", default=None, help="Deprecated alias for a local PDG PDF path")
    s.add_argument("--download", action="store_true", help="Download official PDG artifacts when no local path is provided")
